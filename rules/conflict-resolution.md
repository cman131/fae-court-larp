# Conflict Resolution — *The Queen's Revel*
...
**3. Resolve ties.**
If both players throw the same sign, compare your scores in the named stat. The higher score wins. If scores are equal, narrate a standoff — neither party achieves their goal, and the conflict may be reopened or abandoned.

**4. Re-tests.**
The losing party may spend **1 point** from the named stat to demand a fresh throw. A new RPS follows the same tie-breaking rules. Either party may spend again for another re-test. This continues until one party can't or won't pay; that party loses. Points spent for re-tests are gone for the night.
...
*See also: [How to Play](../players/how-to-play.md) for the player-facing walkthrough.*
