# Rank and Stats — *The Queen's Revel*

## Rank System

Three tiers, each with fae-flavored names. Pick the set that feels right:

| Tier | Primary (recommended) | Alt 1 | Alt 2 |
|---|---|---|---|
| Leader | **Sovereign** | Crowned | Liege |
| Noble | **Sidhe** | Highborn | Trooping Fae |
| Commoner | **Sprite** | Hob | Solitary Fae |

Below uses Sovereign / Sidhe / Sprite.
